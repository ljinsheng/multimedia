...
//	        		  albums.add(path);
	...
	public static LinkedList<ImageAlbumsInfo> getImageInOneAlbum(Resources res, 
			String[] pathArrary) {
		// TODO Auto-generated method stub
		LinkedList<ImageAlbumsInfo> images=new LinkedList<ImageAlbumsInfo>();
		ImageAlbumsInfo image=null;
		for(String path : pathArrary)
		{
			image=new ImageAlbumsInfo();
